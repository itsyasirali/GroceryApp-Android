    ...
    Column(
        ...
        Row(
            ...
            Image(
                ...
                contentDescription = stringResource(id = com.itsyasirali.groceriesapp.R.string.image_product)
            )
            ...
            Row(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(com.itsyasirali.groceriesapp.R.string.arrow_right)
                )
            }
        }
...
fun FavoriteCardPreview() {
    FavoriteCard(
        productItem = ProductItem(
            ...
            description = "",
            image = com.itsyasirali.groceriesapp.R.drawable.product10,
            unit = "7pcs, Priceg",
            price = 4.99,
            nutritions = "100gr",
            review = 4.0
